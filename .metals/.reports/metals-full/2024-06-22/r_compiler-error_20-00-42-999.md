...
### file%3A%2F%2F%2FC%3A%2FUsers%2FPR%2FOneDrive%2FDocuments%2FScala%2Fscala_pattern_matching%2FLinkedlist.scala:7: error: `]` expected but `)` found
...
object Linkedlist{
    ...
    def printlist[A](list: LinkedList[A]): Unit = list match{
        case Empty => println("End os the list")
        case Node(value, next) =>
            println(value)
            printlist(next)
    }
...
scala.meta.internal.parsers.Reporter.syntaxError(Reporter.scala:16)
	...
	scala.meta.internal.parsers.ScalametaParser.scala$meta$internal$parsers$ScalametaParser$$inBracketsAfterOpen(ScalametaParser.scala:300)
