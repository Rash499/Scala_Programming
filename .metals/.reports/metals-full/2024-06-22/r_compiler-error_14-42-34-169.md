...
### file%3A%2F%2F%2FC%3A%2FUsers%2FPR%2FOneDrive%2FDocuments%2FScala%2FLabsheet02.scala:11: error: `identifier` expected but `def` found
...
object Labsheet02{
    ...
    def calculatetotlaincome(attendees:Int, ticketprice:Int):
    def calculatetotalcost(attendees: Int) : Int = 500 + attendees*3
