...
### file%3A%2F%2F%2FC%3A%2FUsers%2FPR%2FOneDrive%2FDocuments%2FScala%2Fscala_pattern_matching%2FLinkedlist.scala:13: error: `identifier` expected but `=` found
    def sum(list: LinkedList[Int]):  = list match{
                                     ^
