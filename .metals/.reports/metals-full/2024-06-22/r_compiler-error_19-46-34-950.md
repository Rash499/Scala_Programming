...
### file%3A%2F%2F%2FC%3A%2FUsers%2FPR%2FOneDrive%2FDocuments%2FScala%2Fscala_pattern_matching%2FLinkedlist.scala:4: error: `:` expected but `)` found
    case class Node[+A](value: A, next)
                                      ^
