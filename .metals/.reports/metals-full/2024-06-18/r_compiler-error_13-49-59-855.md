...
### file%3A%2F%2F%2FC%3A%2FUsers%2FPR%2FOneDrive%2FDocuments%2FScala%2Ffunctionalprogramming%2Factivity2.scala:3: error: `identifier` expected but `\n` found
    def max(x:Int, y:Int): i-
                              ^
...
scala.meta.internal.parsers.Reporter.syntaxError(Reporter.scala:16)
	...
	scala.meta.internal.parsers.ScalametaParser$PatternContextSensitive.scala$meta$internal$parsers$ScalametaParser$PatternContextSensitive$$infixTypeRestWithMode(ScalametaParser.scala:938)
	scala.meta.internal.parsers.ScalametaParser$PatternContextSensitive.scala$meta$internal$parsers$ScalametaParser$PatternContextSensitive$$infixTypeRest(ScalametaParser.scala:918)
